...
function createtime() {
    var t = new Date("04/02/2023 00:00:00");
    ...
    let g = "";
    g = r < 18 && r >= 9 ? `<span class='textTip'> <br> 本博客已运行 ${a} 天</span><span id='runtime'> ${r} 小时 ${i} 分 ${l} 秒 </span> <i class='fas fa-heartbeat' style='color:red'></i>` : `<span class='textTip'> <br> 本博客已运行 ${a} 天</span><span id='runtime'> ${r} 小时 ${i} 分 ${l} 秒 </span> <i class='fas fa-heartbeat' style='color:red'></i>`, document.getElementById("workboard") && (document.getElementById("workboard").innerHTML = g)
}
